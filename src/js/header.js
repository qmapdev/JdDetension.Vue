...
const flytoDefaultPos = () => {
  ...
  const v3 = Q3D.vector3(
    -80.02993774414062,
    0.7770623564720154,
    4.415187358856201
  );
  gc.flyTo(v3d, v3, 0, function() {
    store.commit("RECORD_FACEOUT_DISPLAY", true);
  });
};
...
const keepingFlytoPos = () => {
  ...
  gc.flyTo(v3d, v3, 2, function() {
    ...
    gc.flyTo(v3d, v3, 2, function() {
      store.commit("RECORD_FACEOUT_DISPLAY", false);
    });
  });
};

export { flytoDefaultPos, keepingFlytoPos };
